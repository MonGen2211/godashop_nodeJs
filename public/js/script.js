...
// Thay đổi province
    ...
    // gọi displayCart khi lần đầu tiên duyệt vào trang web
    displayCart();
...
// Lấy giá trị của cookie đỗ lên giỏ hàng ở giao diện web người dùng
    ...
    for (const key in cart.items) {
        ...
        <div class="clearfix text-left">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3"><input type="hidden" value=""><input type="number" onchange="updateProductInCart(this,${item.product_id})" min="1" value="${item.qty}"></div>
